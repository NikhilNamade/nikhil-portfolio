...
const About = () => {
  return (
    <section className="min-h-screen w-full bg-[#020617] text-white px-4 sm:px-6 py-16 sm:py-20 rounded-lg">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-10">
        ...
        {/* Right Content */}
        <div className="lg:col-span-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 sm:p-10">
